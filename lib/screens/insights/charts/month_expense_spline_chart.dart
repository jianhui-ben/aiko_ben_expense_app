...
class MonthExpenseSplineChart extends StatefulWidget {
  final List<Transaction> transactions;
  const MonthExpenseSplineChart({super.key, required this.transactions});

  @override
  State<MonthExpenseSplineChart> createState() => _MonthExpenseSplineChartState();
}

class _MonthExpenseSplineChartState extends State<MonthExpenseSplineChart> {
